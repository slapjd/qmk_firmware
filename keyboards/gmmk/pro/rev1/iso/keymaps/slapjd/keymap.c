...
//      Ct_L     Win_L    Alt_L                               SPACE                               Alt_R    FN       Ct_R     Left     Down     Right
    ...
    [_BASE] = LAYOUT(
        ...
        MO(_FN), KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_NUHS, KC_ENT,           RGB_RMOD,
    ...
    [_FN] = LAYOUT(
        ...
        _______, _______, _______, _______, MO(_RH), _______, _______, _______, _______, _______, _______, _______, _______,                   _______,
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    ...
    [_RH] =  { ENCODER_CCW_CW(RGB_HUD, RGB_HUI) }
};
#endif
